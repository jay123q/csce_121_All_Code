...
private:
  ...
  Node* copy() const;
  // next
  // if theres one thing then its nullptr
...
public:
 ...
 // void removeDeleteThis(std::string id, int fov, double volume, double center_x, double center_y, double min_x, double max_x, double min_y, double max_y);
